...
#' @param var if there are subgroups within the DT, eg if the DT is the result of some kind of sensitivity analysis on spatsoc spatial buffers, include that field here
