...
change for any habitat types (Figure \@ref(fig:socres)b). Layer similarity was
...
relevance (Figure \@ref(fig:winlen)b).  Furthermore, though the layers were generally not very similar
...
connections an individual would have across these networks. 

 Taken together, these results suggest the optimal social
...
<!-- spatial/lc -->
Overall, these results indicate the importance of matching
...
Connective redundancy increased marginally with
...
increased when time length was greater (Figure \@ref(fig:winlen)d). 

<!-- time window position -->
Similar to window length, changing the position of the
...
provide a way to bridge these different scales to examine social
...
These considerations may be limiting factors
