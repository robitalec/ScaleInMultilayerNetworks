...
We altered the temporal scale of multilayer networks using a moving time-window
approach to define seasons and 
...
**Observational scale** <!--(temporary header)-->: Studies of social network analysis
