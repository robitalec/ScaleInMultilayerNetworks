...
degree at ~500m (Figure \@ref(fig:socres)b). Regardless of social scale, layer relevance did not
...
for forage habitats (Figure 4c). Connective redundancy decreased with increasing
landcover resolution due the decrease in connectivity of individuals in winter
forage habitats, resulting in a multilayer network where neighbours were less
frequently repeated in multiple layers (Figure 4b). Layer similarity was
generally stable for forest and open habitats except for a contrasting increase
in similarity for forest and decrease in similarity for open habitats at 250m
landcover resolution (Figure 4a). Layer similarity was not possible to calculate
between winter and summer forage because, at all landcover resolutions greater
than 10m there were no individuals connected in the network layers. <!--
individuals still used forage but in much lower proportion + lowered opportunity
to associate --> These results indicate the importance of matching landcover
...
and ~300 observations for forage (Figure 5a). Once sufficient observations were
used, layer similarity stabilized with additional for all three landcover
classes at ~200 observations for forest, ~300 observations for open and forage.
Connective redundancy increased with increasing number of observations as
individuals became more connected to neighbours in multiple layers (Figure 5b).
Given the overall trend of these multilayer metrics stabilizing after a certain
...
sufficiently describing the social dynamics across contexts.
...
class (Figure 6a). Individual graph strength and layer relevance increased for
all summer layers as individuals became more connected with increasing window
lengths (Figure 6c, Figure 6d). These results suggest that an increasing window
length, especially for the summer season, may be resulting in less precisely
defined seasons that are not clearly capturing periods of aggregation and
dissaggregation according to resource availability and presence of conspecifics. Similarly, 
