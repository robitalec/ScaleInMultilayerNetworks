...
otherwise be missed [@Turner_2018]. Defining temporal scales is a challenge in
...
Animals use space for resource, considering conspecifics

social structure is influenced by resources

animals selectively use resources + can be measured by RSFs
...
available resources or landscape features by animals [@Manly_1993; @Boyce_1999]. Combined,
social structure and habitat selection are intimately linked as individuals must
share space to interact and the distribution of resources influences home range size
and group dynamics [@Webber_2018]. 


Habitat selection is a scale-sensitive process
Animals select habitats at multiple scales 


<!-- Mayor scale --> Multilayer networks represent a novel framework for considering the influence of habitat selection and space use on sociality across scales.
...
Multilayer networks remain a nascent but powerful tool in animal behavioural ecology. We
demonstrate novel analyses that vary social, spatial, and temporal scale within
a multilayer framework. In our caribou case study, we show that (1) multilayer social networks can be,
but are not always, scale dependent, and (2) the use of multilayer networks
...
highlight potential to identify scales at which different properties of
layers within a multilayer network show the most variability. Furthermore, we discuss the potential integration of individual phenotypes and fitness, collective movement, and habitat selection for future
...
Multilayer networks are complicated in that they can incorporate data as varied as social interactions, landscape features, and seasons, all of which exist at different scales and units of measurement. 
Our analysis of caribou multilayer networks incorporated high resolution GPS telemetry data and
spatial landcover data is grounded in the context of observed animal social networks, as the scales we chose to explore are ones that can be observed as has traditionally been done.
