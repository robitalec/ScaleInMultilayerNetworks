...
<!-- Figure 3: metrics by social scale -->
...
<!-- Figure 4: metrics by landcover resolution -->
...
class (forest, lichen and open) across two seasons (summer and winter), and four
...
in winter lichen layer relevance at higher landcover resolutions. C) Similarity
...
layers at 250 m. Note that lichen layer similarity is not shown because
individuals did not interact in lichen habitats greater greater than 10 m
...
<!-- Figure 5: metrics by number of observations -->
