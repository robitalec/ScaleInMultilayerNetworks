...
must share space to interact [@Webber_2018]. Johnson (1980) identified four
...
range scale, it may be relevant to assess social structure at the home range
overlap scale in a multilayer framework. By contrast, in cases where individuals
select habitats at the patch-scale, more fine-scale measures of sociality may be
