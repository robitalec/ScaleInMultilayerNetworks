...
of each other for grooming yet other animals use interactions that do not
require proximity such as long-distance vocalization or olfactory signals
...
patterns in different habitat types, potentially suggesting different types of
interactions. Higher graph strength in forage and open habitats may indicate
that caribou use visual or other cues not relevant in forest habitats (Figure
\@ref(fig:socres)).
...
across developmental stages that may otherwise be missed [@Turner_2017]. Thus,
...
multilayer networks, we pose an additional set of questions on the future of multilayer
networks through the lens of scale and behavioural, landscape, and spatial ecology:
