...
Johnson (1980) identified four orders of habitat selection: (1)
...
social network graph strength differed between seasons, where 
...
resolution increased, edge overlap decreased in foraging habitats while remaining stable in
open and forest habitats (Figure \@ref(fig:socres) D). Foraging is a rare (13% of the landscape) and
patchy habitat on Fogo Island and the proportion of relocations in foraging habitat
type decreased as spatial resolution increased (~15% at 30 m - <2% at 1000 m). Similar to increasing social distance threshold, the influence
...
increasing spatial resolution and variation between individuals. Foraging and open
layers had greater individual variation in graph strength, while foraging was the
...
specifically a social distance threshold, to define social associations. We
found increasing individual graph strength across three habitat layers with
increasing social distance threshold (Figure \@ref(fig:socres)). <!-- This means blah blah for different types of interactions.--> In addition, 
habitat layers differed in their response to social distance threshold, with
open and foraging with a larger increase in graph strength and greater variation
across individuals. <!-- What could this mean biologically? --> These results emphasize that multilayer network metrics are
