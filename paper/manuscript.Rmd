...
[Figure \@ref(fig:spacetime), @Franks_2010]. Further, for social
interactions or associations to occur individuals must share space, and thus
...
association and home range overlap, vary predictably with social interaction
 [@Castles_2014; @Farine2015a]. Thus, we define social scale as the type of
...
phenotypes and individual fitness [@Webber_2018], movement ecology and collective
...
access forage (Bergerud 1974)<!-- TODO: get Bergerud ref-->. As a result,
caribou tend to occupy and re-use craters once they are established and there is
