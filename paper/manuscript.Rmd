...
<!-- TODO: this first sentence is not about layer similarity - so hopefully it isn't
guiding the reader the wrong way -->
Contrasting seasons of sociality become more similarly connected with window
length. Mean graph strength and layer relevance increased for summer layers as
individuals became more connected with increasing window lengths (Figure
\@ref(fig:winlen)a, Figure \@ref(fig:winlen)b). In contrast, mean graph strength
and layer relevance was relatively stable for winter layers. Similarity of
layers across habitat classes and between seasons (e.g. open summer compared to
open winter) was variable across window lengths (Figure \@ref(fig:winlen)c).
Connective redundancy increased marginally with increasing window length. These
