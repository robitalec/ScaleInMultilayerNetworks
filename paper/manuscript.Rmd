...
Social structure is influenced by resource
availability and seasonality [@Peignier_2019], configuration [@He_2019] and
fragmentation [@Banks_2007]. Habitat selection, the disproportionate use of
available resources or landscape features by animals [@Manly_1993; @Boyce_1999], is a scale dependent process [@Mayor_2009].
