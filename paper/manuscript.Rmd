...
are directly linked to the scale at which they are observed [@Levin_1993; @Allen_2015]. Animals are influenced across scales, through processes such as
species-specific as trophic interactions and resource availability [@Legendre_1993; @Chave2013] and global climate and productivity [@Field_2009].
Multiscale ecology has been integrated into species distribution modelling [@Elith_2009; @Mayor_2007; @Sugihara_1989], habitat selection, and food webs. Meanwhile, in the context of animal behaviour, certain
behaviours are scale dependent, for example, acoustic communication in birds
occurs over variable spatial scales [@Luther_2009]. We posit that animal
