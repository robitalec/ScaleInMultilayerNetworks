...
the social and spatial environments.<!--  <- long sentence with two coulds --> For example, social processes may be an 
...
<!-- 
TODO: cut down to this

Given recent technological advancements in biologging and wildlife tracking technology 
[@Borger_2020], remotely sensed data provides a unique opportunity to use
multilayer social network analysis to answer complex questions about animal
socioecology
