...
Landscape classification data were provided by the Newfoundland and Labrador Wildlife Division. Available landcover classification included nine habitat types, which we distilled into two broad categories: open and closed habitat types. Open habitat consisted of lichen, wetland, rocky barrens, frozen lakes, and anthropogenic habitat types, while closed habitat consisted of coniferous forest, conifer scrub, broadleaf forest, and mixed-wood forest habitat types.
...
Sample same landcover product at different scales. Landcover is the Fogo landcover product. Resampled using `grainchanger` from regular resolution (believe it's 30m), to 100m, 250m, 500m, 1000m, 2500m (tentative numbers). Resampling method was modal moving window. Water areas were masked before resampling. Landcover reclassified to open, forest and lichen. 
