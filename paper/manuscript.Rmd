...
sociality. Multilayer networks consisted of the social association between `r
DT[, uniqueN(get(idcol))]` individuals across 20 ordinal sample periods of 35-36
days from the entire study period. Social associations of individuals were
defined by spatiotemporal overlap within 5 minutes and 50 m. Within each time
window, we calculated individual's graph strength and multidegree. We calculated
edge overlap across the entire series of networks to determine proportion of
total edges observed in each time window.
