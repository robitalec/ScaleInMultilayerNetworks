...
We modified the distance threshold, hereafter the social threshold, required for group assignment using
`spatsoc` [@Robitaille_2019] and re-assigned groups at incremental
