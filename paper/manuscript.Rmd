...
available resources or features by animals [@Manly_1993; @Boyce_1999]. Combined,
social structure and habitat selection are intimately linked as individuals must
share space to interact and distribution of resources influence home range size
and group dynamics [@Webber_2018]. <!-- Mayor scale --> Multilayer networks represent a novel framework for considering the influence of habitat selection and space use on sociality across scales.
