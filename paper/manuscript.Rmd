...
available resources resources or features by animals [@Manly_1993; @Boyce_1999].
...
influences group dynamics and home range size [@Webber_2018]. Animals select
habitats at multiple scales ... (Mayor) <!-- Mayor scale --> Multilayer
...
scale is insufficient for generalizing across scales. Habitat selection is often
measured using resource selection functions (RSFs) and species distribution
models (SDMs). Both of these methods are based on the proportion of used
resources and available resources for an animal. Johnson (1980) identified four
orders of habitat selection: (1) the geographical range of a species, (2) the
home range of an individual, (3) the habitat patches within the home range and
(4) specific resources within a habitat patch. Extending beyond this
hierarchical perspective, Mayor (2009) reviewed scale in habitat selection and


Habitat selection - can be measured by RSFs and importance of scale: 
Scale in habitat selection... Mayor (2019)

Habitat selection is scale dependent and 
*  Johnson (1980) 
...
Multilayer networks can be combined to consider habitat selection, across scales

Animal social systems can be parsed by spatial contexts, defined by habitat types or connectivity, each represented in a layer within a multilayer framework
Seasonality of resources can be directly measured by investigating differences in habitat selection and sociality between seasonal layers  

Taken together, these novel and explicit integrations of habitat selection and space use in multilayer netwokr
