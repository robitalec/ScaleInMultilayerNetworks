...
and individual would have across all networks (Figure \@ref(fig:socres)c).
...
Larger landcover resolution scale resulted in decreased proportion of rare and
...
neighbours were less frequently repeated in multiple layers (Figure
\@ref(fig:lcres)b). Layer similarity was generally stable for forest and open
...
Like coarse landcover resolution (above), low number of observations were not
sufficient for capturing individuals in all contexts and layer similarity could
not be calculated below ~75 observations for forest, ~210 observations for open
and ~300 observations for forage (Figure \@ref(fig:nobs)a). Once sufficient
observations were used, layer similarity stabilized with additional for all
three landcover classes at ~200 observations for forest, ~300 observations for
open and forage. Connective redundancy increased with increasing number of
