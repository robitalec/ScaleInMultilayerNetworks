...
certain behaviors. Despite animals selecting for different landscape attributes
...
<!-- TODO: weak -->
Multilayer networks can be used to explicitly consider habitat selection and
...
The effect of seasonality of resources can can be directly measured by differences in
