...
Combined, social structure and habitat selection are intimately linked as
individuals must share space to interact and the distribution of resources
influences home range size and group dynamics [@Webber_2018]. Animals select
habitats are multiple scales ... (Mayor) <!-- Mayor scale --> Multilayer
...
Habitat selection - can be measured by RSFs and importance of scale: 

*  Johnson (1980) identified four orders of habitat selection: (1) the geographical range of a species, (2) the home range of an individual, (3) the habitat patches within the home range and (4) specific resources within a habitat patch.


What new insights will multilayer networks lead to 
