...
multiple layers, each representing (i) different classes of individuals, e.g.
...
integrating scale within these remains an unexplored opportunity to develop 
...
interpret complex social systems. Second, we address how variation in the
social, spatial, and temporal scale improves our understanding of the
relationship between social association and seasonal resource availability. We
conclude with potential future developments and applications of scale in
multilayer networks.
...
on snow cover and distribution of craters on the landscape. Home range sizes for 
...
https://github.com/robitalec/scale-in-multilayer-networks [@Robitaille_2020] <!-- TODO: zenodo-->
and released under the GNU General Public License 3.0. We depended on numerous R
packages notably for the analysis: igraph, data.table, spatsoc, asnipe, and
grainchanger, for the figures: ggplot2 and patchwork, and for reproducibility
and workflow management drake, renv, and knitr.
