...
interactions to co-occurrence to overlapping home ranges. <!-- TODO: add temporal scale --> Multilayer networks
...
understanding of an animal’s perception of scale. Here we discuss
...
and space use. <!-- TODO: (REF)--> <!-- TODO: Webber reference should be 2018,
but defaulting to 2017-->
