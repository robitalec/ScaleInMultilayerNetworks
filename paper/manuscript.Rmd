...
(Castles et al. 2014; Farine 2015). Thus, we define social scale as the type of
social relationship observed that can be explicitly defined and measured (Farine
et al. 2015).
...
et al. (2010)<!-- TODO: get Bjorneraas ref-->. We did not collar all female
caribou in the herd; however, we assumed that our sample of collared animals was
random.
...
these processes [@Mourier_2019]. Movement as a collective group can 
...
individuals at a given node [@Mourier_2019]. Although movement between 
...
movement decisions in the context of their local environment (Strandburg-Peshkin et al. 2015, 2017) and across scales. A
...
to questions of collective movement (e.g Strandburg-Peskin et al. 2015). 
...
over large distances and time scales (Torney et al. 2019). Using 
