...
space, and thus have overlapping home ranges [@VanderWal_2014]. In the context of the social
environment, home range overlap is a relatively coarse scale of sociality across
which individuals share space over larger spatial and temporal scales [e.g.
@Piza_Roca_2018]. <!-- double coarse -->Although the social environment clearly scales spatially and
