...
\@ref(fig:socres)b). Connective redundancy increased rapidly when groups were
formed up to ~100 m threshold, followed by a plateau and slight decrease at
higher thresholds, presumably due to an increase in summer forest degree at ~500
m (Figure \@ref(fig:socres)d). Taken together, these results suggest the optimal
<!-- TODO: why optimal -->
...
<!-- TODO: missing summer relevance and all layer similarily--> 
