...
* we generated a six layer multilayer social network consisting of two aspects
(season and landcover)
* elementary-layer sets for two seasons (winter and summer) and three landcover
classes (open, forest and lichen).
* This multilayer network is not node-aligned as not all individuals exist on
all layers
* This layer has both ordinal and categorical coupling
...
[@Robitaille_2019] in `r version$version.string` [@R_Core_Team_2019].
