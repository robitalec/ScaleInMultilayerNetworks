...
development and application of scale in multilayer networks with respect to phenotypes and individual fitness (Webber & Vander Wal 2018), movement ecology and collective
...
context of (1) phenotypes and individual fitness (Webber & Vander Wal 2018), (2) 
...
technology can be used to measure how groups of
...
and satellites, can be used to track the fine-scalemovements of  
groups over large distances and time scales (Torney et al. 2019). Using 
