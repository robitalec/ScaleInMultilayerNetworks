...
Social networks constructed using spatsoc (Robitaille et al. 2019). Multilayer networks constructed for each season. Variable modified is the spatial buffer. Series from 5 to 500. 
