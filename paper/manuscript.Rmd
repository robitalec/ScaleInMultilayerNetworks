...
reviewed types of scale relevant in measurement of habitat selection and recommend using a continuum of scales for identifying characteristic scales of selection. For example, @Mayor_2007 showed caribou selection for shallow snow across all sales and used to a continuum of scales to avoid bias from narrowing the measurements to scales assumed to be associated with certain behaviors. 
...
ecology. We demonstrate the potential novel analyses that vary social, spatial, and temporal
...
and time, are ones that can be observed as has traditionally been done in ethology. Thus, we
...
at which scale might these influence fitness? Are some scales better predictors for
