...
individuals became more connected and metrics appeared to stabilize.
Mean graph strength varied in winter layers becoming stable at ~200 m and remained consistently weak in summer layers (Figure \@ref(fig:nobs)a). Layer relevance in winter layers increased between ~10 - ~50 observations, remaining stable with additional observations (Figure \@ref(fig:nobs)b). 
<!-- TODO: update with fix for open/rerun -->
Like coarse landcover resolution (above), low numbers of observations were not
sufficient for capturing individuals in all contexts and therefore layer similarity could
not be calculated below approximately <!--TODO: update these -->75 observations for forest, approximately 
...
Connective redundancy increased dramatically between ~10 - ~50 observations before stabilizing with all new observations included (Figure \@ref(fig:nobs)d). 
Given the observed trend of these multilayer metrics
