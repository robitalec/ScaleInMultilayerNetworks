...
(Webber & Vander Wal 2018), (2)  movement ecology and collective movement (Bode et al. 2011), 
and (3) habitat selection and space use (He et al. 2019).
Here, we explore how mutlilayer networks may apply to these emerging fields to
contribute to the development of social network theory and application.
...
### 1
Habitat selection and shared space use *link to social*
Habitat selection depends on 
species specific
individual differences in home range and habitat selection
percentage of home range overlap links to foraging quality and availability in herbivores
multilayer networks are "a potential framework" for investigating social dynamics given shared space use and individual habitat selection
