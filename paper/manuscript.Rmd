...
example, @Mayor_2007 showed caribou selection for shallow snow across all sales
and used to a continuum of scales to avoid bias from narrowing the measurements
to scales assumed to be associated with certain behaviors.
...
The influence of resource phenology can be directly measured by differences in
