...
Due to the autocorrelated nature of biologging data that we recommend users ensure social association data are non-randomly distributed [@Farine_2017b].
...
<!-- fitness -->
Social phenotypes can change over ontogeny in ways that
...
However, considering fine temporal scales has been show to
...
Furthermore, given the non-independent nature of social
