...
foraging, open, and forest habitats. Foraging habitat consisted of foraging, open
...
three habitat layers (open, forest and foraging) for the entire study period. At
...
foraging) for the entire study period. Social associations of individuals were
...
across three habitat layers (open, forest and foraging) using $N$ randomly
...
similar and higher graph strength in open and foraging layers, and lower strength
