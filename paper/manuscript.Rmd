...
for forage habitats (Figure 3c). Connective redundancy decreased with increasing
...
frequently repeated in multiple layers (Figure 3b). Layer similarity was
...
landcover resolution (Figure 3a). Layer similarity was not possible to calculate
