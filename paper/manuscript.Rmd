...
social threshold is greater than approximately 50 m during the summer **check**,
individuals demonstrate dramatically different graph strength **cite spatial threshold fig** 
in different habitat types, having dramatically higher graph
strength in forage and open habitats than forest where they can likely see each
other better and still interact with visual cues. Varying social scales can have
different fitness repercussions for individuals. Rhesus macaques (*Macaca mulatta*) 
had higher survivorship when they had fewer but stronger, more stable
...
there was a lot of variation in the multilayer network metrics **cite winpos and winlen**. 
...
otherwise be missed [@Turner_2018].
