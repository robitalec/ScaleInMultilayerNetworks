...
[@R_Core_Team_2019]. *FIX VANDER WAL IN SPATSOC REF*
...
degree at ~500m (Figure \@ref(fig:socres)b). Regardless of social scale, layer
...
an individual would have across all networks (Figure \@ref(fig:socres)c).
...
for forage habitats (Figure \@ref(fig:lcres)c). Connective redundancy decreased
...
time understanding this previous sentence --> (Figure\@ref(fig:lcres)b). Layer similarity 
...
\@ref(fig:lcres)a). Layer similarity was not possible to calculate between
...
observations for openand approximately 300 observations for forage (Figure 
\@ref(fig:nobs)a). Once sufficient observations were obtained, layer similarity stabilized 
...
layers (Figure \@ref(fig:nobs)b). Given the overall trend of these multilayer
...
class (Figure \@ref(fig:winlen)a). Individual graph strength and layer relevance
increased for all summer layers as individuals became more connected with
increasing window lengths (Figure \@ref(fig:winlen)c, Figure
