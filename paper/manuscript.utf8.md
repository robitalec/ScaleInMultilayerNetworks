...
habitat selection and space use (REF)<!-- TODO-->, individual fitness and
...
[@Berlingerio_2012; @Kivela_2014]. Comparing the multidegree and number of
...
[@Berlingerio_2012]. To measure the role of individuals, we calculated the graph
strength for each individual for each layer specific season and landcover
context <!-- citation?-->. Finally, we calculated the similarity of layers
between seasons, across landcover classes (e.g.: winter open compared to summer
open) using the Pearson correlation coefficient [@Br_dka_2018].
